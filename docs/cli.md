...
through the existing IO helpers, checks that prediction and ground-truth shapes
match, runs the requested metrics, and writes an `EvaluationResult` JSON file.
